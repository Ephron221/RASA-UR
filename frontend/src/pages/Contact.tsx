...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      notify("Divine Connection", "Thank you for reaching out to RASA. Your inquiry has been synchronized with our stewards. We will respond shortly.", "divine");
      (e.target as HTMLFormElement).reset();
    } catch (err) {
      console.error(err);
      notify("Transmission Delay", "An error occurred in the divine circuit. Please attempt synchronization again.", "info");
    } finally {
