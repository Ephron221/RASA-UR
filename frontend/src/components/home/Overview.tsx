      ...
      <div className="max-container px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-10 -right-10 bg-secondary text-white p-10 rounded-[3rem] shadow-2xl max-w-xs space-y-4">
              <Quote size={40} className="opacity-30" />
              <p className="font-serif italic text-xl">"{config.aboutScripture}"</p>
              <p className="text-[10px] font-black uppercase tracking-widest text-white/60">{config.aboutScriptureRef}</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-8 pt-6">
              <div className="space-y-2">
                <p className="text-3xl font-black text-black">{config.stat1Value}</p>
                <p className="text-xs font-bold text-black/40 uppercase tracking-widest">{config.stat1Label}</p>
              </div>
              <div className="space-y-2">
                <p className="text-3xl font-black text-black">{config.stat2Value}</p>
                <p className="text-xs font-bold text-black/40 uppercase tracking-widest">{config.stat2Label}</p>
              </div>
            </div>
          </motion.div>
